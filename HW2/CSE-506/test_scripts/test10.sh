...
rm -rf /mnt/bkpfs/a*
head -c 40960 </dev/urandom > my_file
...
if cmp /test/HW2_v6/.bkp.a.6 /mnt/bkpfs/a;then
	echo "******************************"
	echo "Testing for the content of the latest backup file with medium size--------->passed"
	echo "*********************************"
else
	echo "******************************"
	echo "Testing for the content of the latest backup file with medium size------->failed"
	echo "*********************************"
fi
